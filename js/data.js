...
const qnaList = [
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'b. 언제 연락할지, 어떻게 말할지 심사숙고하여 연락한다.', type: ['cow', 6, 5, 10] },
  ...
  },
  {
    q: '3. 당신의 고백 스타일은?',
    a: [
      { answer: 'a. 호감이 보이면 바로 고백한다', type: ['cow', 3, 2, 10, 8] },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 박력 그 자체, "야 나랑 사귀자" ', type: ['cow', 2, 4] },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 쑥스러워.. 손 잡기 정도??', type: ['cow', 7, 10, 4, 9] },
...

  {
    ...
    a: [
      ...
      { answer: 'c. 이미 깜짝 이벤트 다 준비해놨어', type: ['cow', 7, 2, 5, 8] },
    ]
  },
  {
    q: '7. 연인이 오늘 머리를 바꾸고 옷도 새로 샀다',
    a: [
      { answer: 'a. 눈치 못 채고 그냥 있는다', type: ['cow', 7, 11] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'c. 집 앞까지 데려다준다.', type: ['cow', 7, 11] },
    ]
  },
  {
    ...
    a: [
      ...
      { answer: 'b. 초조해서 마음 졸이며 인스타, 페북, 카톡 등 모든 SNS 다 들어가본다.', type: ['cow', 3, 6, 11] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'c. 헐 대박, 어디야?? 당장 나갈게!', type: ['cow', 7, 3, 10, 8] },
    ]
  },
  {
    q: '11. 내가 추구하는 연애관은? ',
    a: [
      { answer: 'a. 각자 할 것 하며, 평안하고 안정적인 연애가 좋다.', type: ['cow', 4, 9, 11] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'c. "아니 그건 아니고, 하.." 조용히 운다.', type: ['cow', 7, 11] },
    ]
  }
]
